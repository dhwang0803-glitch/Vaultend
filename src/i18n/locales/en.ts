const en = {
  ...
  'settings.rulePlaceholderFolder': 'Folder name (e.g. Private/)',
  'settings.rulePlaceholderTag': 'Tag name (e.g. #secret)',
  'settings.rulePlaceholderFrontmatter': 'key: value (e.g. category: draft)',
  'settings.ruleFrontmatterGuide': '"key: value" to match a specific value, or just "key" to exclude notes with that property.',
  'settings.ruleFrontmatterCommaWarning': 'Only one pattern per rule. To exclude multiple conditions, add separate rules.',
  'settings.ruleFrontmatterTooltip': 'Exclude notes by Properties (frontmatter).\n\nExamples:\n• category: draft → notes where category is "draft"\n• private → any note with a "private" property\n• status: wip → notes where status is "wip"\n\nOne pattern per rule. Case-insensitive value matching.',
  'settings.rulePlaceholderRedact': 'Select a preset below, or enter custom regex',
  'settings.redactPresetsTitle': 'Common patterns — click to apply',
  'settings.redactCategoryContact': 'Contact',
  'settings.redactCategoryIdentity': 'Identity',
  'settings.redactCategoryFinancial': 'Financial',
  'settings.redactCategorySecurity': 'Security',
  'settings.redactCategoryNetwork': 'Network',
  'settings.redactPresetEmail': 'Email',
  'settings.redactPresetPhoneKR': 'Phone (KR)',
  'settings.redactPresetPhoneUS': 'Phone (US)',
  'settings.redactPresetRRN': 'Korean RRN',
  'settings.redactPresetSSN': 'US SSN',
  'settings.redactPresetCard': 'Card number',
  'settings.redactPresetBankKR': 'Bank acct (KR)',
  'settings.redactPresetCrypto': 'Crypto wallet',
  'settings.redactPresetPassword': 'Password',
  'settings.redactPresetAPIKey': 'API key',
  'settings.redactPresetPrivateKey': 'Private key',
  'settings.redactPresetIP': 'IP address',
