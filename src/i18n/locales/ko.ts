...
const ko: { [K in keyof typeof en]: string } = {
  ...
  'settings.suppressionsTitle': '억제된 제안',
  'settings.suppressionsDesc': '거절한 제안은 일시적으로 억제됩니다. 제거하면 즉시 다시 표시됩니다.',
  'settings.suppressionExpires': '{{days}}일 남음',
  'settings.suppressionExpired': '만료됨',
  'settings.suppressionRemove': '억제 해제',
